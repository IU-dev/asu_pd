    ...
    <?php else : ?>
        <center>
            <form class="md-form border border-light p-5 fixed-25em" action="login.php" method="post">
                ...
                <button class="btn btn-primary btn-block my-4 fixed-15em" type="submit" name="submit-login">Войти</button>

                <button class="btn btn-primary btn-block my-4 fixed-15em" name="submit-login-lk">Войти через ЛК студента</button>
